...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFAULT] = LAYOUT_iso(
        ...
        KC_TAB,     JP_Q,    JP_W,    JP_E,    JP_R,    JP_T,    JP_Y,          JP_Y,    JP_U,    JP_I,    JP_O,    JP_P,    JP_AT, JP_LBRC,      KC_ENT,
        ...
        KC_LCTL, KC_LGUI, KC_LALT,       JP_MHEN,  KC_SPC,                           KC_SPC,                                KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT,
                                                                 JP_MHEN,       JP_HENK
    ),
    [_MOUSE] = LAYOUT_iso(
    ...
    [_CONFIG] = LAYOUT_iso(
        ...
        QK_RBT,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      QK_RBT,
        XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                 XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                XXXXXXX,                          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                                              XXXXXXX,              XXXXXXX
